...
var CompoundSearch = require("./CompoundSearch");

console.log(CompoundSearch);

var OPSCompoundInfo = Class({
     /** @lends Biojs.OPSCompoundInfo# */
         constructor: function(options) {
            ...
            var self = this;
            var searcher = new CompoundSearch(this.opt.appURL, this.opt.appID, this.opt.appKey);
...
Events.mixin(OPSCompoundInfo.prototype);
module.exports = OPSCompoundInfo;
